...
export class MemStorage implements IStorage {
  ...
  private initialize() {
    ...
    const gameData: Game[] = [
      { id: "crossfire", name: "CROSSFIRE", slug: "crossfire", description: "ZP Points & Weapons", price: "50.00", currency: "EGP", image: "/attached_assets/CROSSFIRE.png", category: "online-games", isPopular: true, stock: randomStock(), packages: ["1000 ZP", "5000 ZP"], packagePrices: ["50.00", "240.00"] },
      ...
      { id: "pubg", name: "PUBG MOBILE", slug: "pubg-mobile", description: "UC Currency & Royal Pass", price: "29.99", currency: "EGP", image: "/attached_assets/PUBG_MOBILE.jpg", category: "mobile-games", isPopular: true, stock: randomStock(), packages: ["60 UC"], packagePrices: ["29.99"] },
      ...
      { id: "callofduty", name: "CALL OF DUTY", slug: "call-of-duty", description: "COD Points & Battle Pass", price: "250.00", currency: "EGP", image: "/attached_assets/CALL_OF_DUTY.png", category: "online-games", isPopular: true, stock: randomStock(), packages: ["1000 COD Points"], packagePrices: ["250.00"] },
