        ...
        {Array.isArray(games) && games.map((game) => {
          ...
          return (
            <div key={game.id} className="relative group perspective">
              ...
              <div className="relative rounded-2xl overflow-hidden border-2 border-cyan-400/30 bg-gradient-to-b from-gray-900 to-black p-3 sm:p-4 h-[300px] sm:h-[360px] flex flex-col justify-between shadow-lg hover:shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300 hover:border-cyan-400/60 group-hover:glow-cyan cursor-pointer">
                {/* Card glow effect */}
