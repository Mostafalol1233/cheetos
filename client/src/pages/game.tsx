...
const CURRENCY_IMAGES: Record<string, string> = {
  ...
  'pubg': `${CDN}/currency-pubg-uc.png`,
  'free-fire': `${CDN}/currency-freefire-diamonds.png`,
  'freefire': `${CDN}/currency-freefire-diamonds.png`,
  'garena-free-fire': `${CDN}/currency-freefire-diamonds.png`,
  'call-of-duty-mobile': `${CDN}/currency-cod-cp.png`,
  'call-of-duty': `${CDN}/currency-cod-cp.png`,
  'crossfire': `${CDN}/currency-crossfire-zp.png`,
  'league-of-legends': `${CDN}/currency-lol-rp.png`,
  'valorant': `${CDN}/currency-valorant-vp.png`,
  'valornt': `${CDN}/currency-valorant-vp.png`,
  'fortnite': `${CDN}/currency-fortnite-vbucks.png`,
  'roblox': `${CDN}/currency-roblox-robux.png`,
  'honor-of-kings': `${CDN}/currency-hok-tokens.png`,
  'hok': `${CDN}/currency-hok-tokens.png`,
  'mobile-legends': `${CDN}/currency-mlbb-diamonds.png`,
  'mobile-legends-bang-bang': `${CDN}/currency-mlbb-diamonds.png`,
  'mlbb': `${CDN}/currency-mlbb-diamonds.png`,
  'tiktok': 'https://res.cloudinary.com/ddzbutb12/image/upload/v1774181808/gamecart/currency/currency-tiktok-coins-new.png',
  'tiktok-coins': 'https://res.cloudinary.com/ddzbutb12/image/upload/v1774181808/gamecart/currency/currency-tiktok-coins-new.png',
  'minecraft': `${CDN}/currency-minecraft-coins.png`,
  'yalla-ludo': `${CDN}/currency-yalla-diamonds.png`,
  'yalla': `${CDN}/currency-yalla-diamonds.png`,
  'wolf-team': `${CDN}/currency-wolfteam-wcoin.png`,
  'wolfteam': `${CDN}/currency-wolfteam-wcoin.png`,
  'e-football': 'https://res.cloudinary.com/ddzbutb12/image/upload/v1774181809/gamecart/currency/currency-efootball-coin-new.png',
  'efootball': 'https://res.cloudinary.com/ddzbutb12/image/upload/v1774181809/gamecart/currency/currency-efootball-coin-new.png',
  'clash-of-clans': `${CDN}/currency-coc-gems.png`,
  'coc': `${CDN}/currency-coc-gems.png`,
  'apex-legends': `${CDN}/currency-apex-coins.png`,
  'apex': `${CDN}/currency-apex-coins.png`,
  'genshin-impact': `${CDN}/currency-genshin-primogems.png`,
  'genshin': `${CDN}/currency-genshin-primogems.png`,
  'google-play': `${CDN}/giftcard-google-play.svg`,
  'steam': `${CDN}/giftcard-steam.svg`,
  'steam-wallet': `${CDN}/giftcard-steam.svg`,
  'playstation': `${CDN}/giftcard-psn.svg`,
  'playstation-store': `${CDN}/giftcard-psn.svg`,
  'ps-store': `${CDN}/giftcard-psn.svg`,
  'xbox': `${CDN}/giftcard-xbox.svg`,
  'xbox-gift-card': `${CDN}/giftcard-xbox.svg`,
  'xbox-live': `${CDN}/giftcard-xbox.svg`,
  'discord-nitro': `${CDN}/currency-gift-card.png`,
  'discord': `${CDN}/currency-gift-card.png`,
  'netflix': `${CDN}/giftcard-netflix.svg`,
  'netflix-gift-card': `${CDN}/giftcard-netflix.svg`,
  'ea-play': `${CDN}/currency-gift-card.png`,
  'itunes': `${CDN}/giftcard-itunes.svg`,
  'itunes-app-store': `${CDN}/giftcard-itunes.svg`,
  'app-store': `${CDN}/giftcard-itunes.svg`,
  'amazon': `${CDN}/giftcard-amazon.svg`,
  'amazon-gift-card': `${CDN}/giftcard-amazon.svg`,
  'spotify': `${CDN}/giftcard-spotify.svg`,
  'spotify-gift-card': `${CDN}/giftcard-spotify.svg`,
};
    ...
    <>
      ...
      <div className="min-h-screen bg-background" style={GAME_BRAND_COLORS[gameSlug] ? { background: `radial-gradient(ellipse 90% 35% at 50% 0%, rgba(${GAME_BRAND_COLORS[gameSlug]}, 0.07) 0%, transparent 55%)` } : undefined}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl py-6">
          <a href="/world-cup">
            <div className="flex items-center gap-3 bg-gradient-to-r from-[#0d0a00] to-[#0a0800] border border-[#c9a84c]/20 hover:border-[#c9a84c]/40 rounded-xl px-4 py-3 cursor-pointer transition-all group">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-white text-xs font-semibold">توقّع نتائج المباريات واربح كوداً مجانياً · Predict & Win a Free Code</div>
              </div>
