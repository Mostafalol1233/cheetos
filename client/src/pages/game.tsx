...
const CURRENCY_IMAGES: Record<string, string> = {
  ...
  'tiktok': `${CDN}/currency-tiktok-coins.png`,
  'tiktok-coins': `${CDN}/currency-tiktok-coins.png`,
  ...
  'e-football': `${CDN}/currency-efootball-coin.png`,
  'efootball': `${CDN}/currency-efootball-coin.png`,
