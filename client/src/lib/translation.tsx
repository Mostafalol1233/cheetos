...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "cart": "Cart",
    "checkout": "Checkout",
    "checkout_whatsapp_btn": "Complete Order via WhatsApp",
    "details_title": "Your Details",
    "details_desc": "Please provide your details to complete the order via WhatsApp.",
    "redirecting_whatsapp": "Redirecting to WhatsApp...",
    "search": "Search",
  ...
  ar: {
    ...
    "cart": "السلة",
    "checkout": "الدفع",
    "checkout_whatsapp_btn": "إتمام الطلب عبر واتساب",
    "details_title": "بياناتك",
    "details_desc": "يرجى إدخال بياناتك لإتمام الطلب عبر واتساب.",
    "redirecting_whatsapp": "جاري التحويل إلى واتساب...",
    "search": "بحث",
